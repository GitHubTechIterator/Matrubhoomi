...
function editFun()
{
	...
	if(k>0)
	{
		if(k>1)
		{
			alert("Select only one Product for Edit !!!!");
		}
		else{
			var data = [];
			$(":checked").each(function() {
...
<td><input type="button" value="Search" style="color: #fff; font-weight: bold; font-family: Bookman Old Style; background-color: #8B0000; font-size: 20px;" onclick="loadpage1('BranchMasterData.jsp');"></input></td>

<td>
<a  onclick="loadpage12()"> Add Branch
</a></td>
</tr>
</table>
...
<Table  align="center" width="100%">
		<Tr><Th align="center" colspan="13" style="color: #fff; font-weight: bold; font-family: Bookman Old Style; background-color: #8B0000; font-size: 20px;">Branch List</Th></Tr>
		<Tr style="color: #fff; font-weight: bold; font-family: Bookman Old Style; background-color: #8B0000;"><Th></Th><Th>Branch ID</Th><Th>Branch Name</Th><th>Branch Code</th><!--<Th>Address</Th>--><Th>City</Th><Th>State</Th><!--<Th>Country</Th><Th>Contact Person</Th><Th>Mobile</Th><Th>Phone No</Th>--><Th>Main Branch</Th><Th>Status</Th></Tr>
...
int i = 0;
		...
		if(searchCri == null || searchCri.equals(""))
		{
			branchId = 0;
		}
		else
		{
			branchId = Integer.parseInt(searchCri);
		}
...
while(rs.next())
{
	...
	%>
				<Tr class="label" style="background-color: #F1ECF0;">
		...
		<Tr align="center" colspan="13" style="color: #fff; font-weight: bold; font-family: Bookman Old Style; background-color: #8B0000; font-size: 20px;">
		<Td colspan="13" align="center"><input type = "button" value="Delete" style="color: #fff; font-weight: bold; font-family: Bookman Old Style; background-color: #8B0000; font-size: 20px;" onclick="deleteFun();"></input>
		<input type = "button" value="Edit" style="color: #fff; font-weight: bold; font-family: Bookman Old Style; background-color: #8B0000; font-size: 20px;" onclick="editFun();"></input></Td>
		</Tr>
		</Table>
		</form>
