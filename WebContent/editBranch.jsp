...
<body>
  ...
  <h1 align="center" style="color: #fff; font-weight: bold; font-family: Bookman Old Style; background-color: #8B0000; font-size: 20px;">Branch Master</h1>
...
try
{
 ...
 <!-- <div class="col-3">
  ...
  <div class="col-submit">
    <button  type="button" class="submitbtn" onclick="loadpage()">Submit Form</button>
  </div>
  <%
	}
	pstmt = null;
